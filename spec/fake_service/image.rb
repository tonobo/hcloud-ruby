    ...
    $IMAGES = {
      "images"=>[
        ...
        },
        {
          ...
          "created_from"=>{"id"=>497533, "name"=>"moo5"}, 
          "bound_to"=>nil, 
          "os_flavor"=>"ubuntu", 
          "os_version"=>nil, 
          "rapid_deploy"=>false
      ...
      group :images do
        ...
        route_param :id do
          ...
          put do 
            ...
            @x["description"] = params[:description] if !params[:description].nil?
            @x["type"] = params[:type] if !params[:type].nil?
            { image: @x }
          end
        ...
        get do
          dc = $IMAGES.deep_dup
          dc["images"].select!{|x| x["name"] == params[:name] } if !params[:name].nil?
          dc["images"].select!{|x| x["type"] == params[:type] } if !params[:type].nil?
          if !params[:bound_to].nil?
